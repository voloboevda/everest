...
name: ui-ux-pro-max
description: >-
  Comprehensive design guide for web and mobile. 67 styles, 161 palettes, 57 font
  pairings, 99 UX guidelines. Use for Everest Trade UI decisions with
  everest-design-taste constraints.
---

# UI UX Pro Max

Searchable design intelligence. For Everest Trade, combine with `everest-design-taste` — prefer Trust & Authority B2B, clean layouts.

Run search: `python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "B2B trading corporate landing"`
